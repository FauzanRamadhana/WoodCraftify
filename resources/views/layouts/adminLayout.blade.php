...
<body class="">
    <div class="">
        <nav class="navbar navbar-expand-lg bg-body-tertiary nav-color shadow-box">
            <div class="container">
                <a class="navbar-brand mt-3 mb-3" href="{{ route('dashboardAdmin') }}"><img src="/img/WOODCRAFTIFY.png"
                ...
                <ul class="navbar-nav mx-auto" style="font-size: 20px">
                    <li class="nav-item">
                        <a class="nav-link mx-3 text-dark @if(request()->routeIs('daftarUser')) fw-bold @endif"
                            aria-current="page" href="{{ route('daftarUser') }}">USERS</a>
                    </li>
                    <li class="nav-item">
